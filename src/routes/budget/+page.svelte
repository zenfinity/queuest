	...
	<section class="space-y-3">
		...
		<div class="flex flex-wrap items-center gap-2 text-sm">
			<input
				...
				class="w-14 rounded-lg bg-white px-2 py-1.5 text-center text-base sm:text-sm font-medium text-gray-900 outline-none ring-1 ring-gray-300 focus:ring-orange-500 dark:bg-gray-900 dark:text-white dark:ring-gray-700 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
			/>
